...
namespace Midterm
{
    public partial class DataCal : ContentPage
    {
        public DataCal()
        {
            InitializeComponent();
        ...
        private void start()
        {
            String[] dataName = { "B", "KB", "MB", "GB", "TB", "PB" };
                ...
                switch (value0)
                {
                    case 0:
                        switch (value1)
                        {
                            ...
                            case 3:
                                total = txt / 1024 / 1024 / 1024;
                                break;
                            case 4:
                                total = txt / 1024 / 1024 / 1024 / 1024;
                                break;
                            case 5:
                                total = txt / 1024 / 1024 / 1024 / 1024 / 1024;
                                break;
                        }
                        break;
        ...
        /*private bool txtChange(string txt)
        {
        ...
        private void InPut00_TextChanged(object sender, TextChangedEventArgs e)
        {
                    if (txtChange(inPut01.Text))
                    {
                        Solution();
                    }
                    if (string.IsNullOrEmpty(inPut00.Text))
        ...
        /*private void InPut00_TextChanged(object sender, TextChangedEventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(inPut00.Text) &&
                !string.IsNullOrWhiteSpace(inPut00.Text))
            {
                double txt = double.Parse(inPut00.Text),
                   total = 0;
                switch (value0)
                {
                    case 0:
                ...
                inPut01.Text = string.Format("{0: #,##0.00######}", total);
            }
            else
            {
                inPut01.Text = null;
